...
// Fixed parameters: m1=m2=1, L1=L2=1. g and dt are uniforms.
...
// Returns d/dt of [theta1, omega1, theta2, omega2] for m1=m2=L1=L2=1
fn derivatives(s: vec4f, g: f32) -> vec4f {
  let t1 = s.x;
  let w1 = s.y;
  let t2 = s.z;
  let w2 = s.w;
...
fn rk4(s: vec4f, g: f32, dt: f32) -> vec4f {
  let k1 = derivatives(s, g);
  let k2 = derivatives(s + 0.5 * dt * k1, g);
  let k3 = derivatives(s + 0.5 * dt * k2, g);
  let k4 = derivatives(s + dt * k3, g);
